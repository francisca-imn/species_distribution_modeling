...
Uno de los aspectos más notorios al analizar las figuras generadas es la presencia de **patrones extraños en los mapas de distribución**, lo que motivó una revisión de las capas climáticas utilizadas en el modelamiento. Se identificó que algunas variables, especialmente la **precipitación acumulada**, podrían estar introduciendo estas estructuras anómalas en los mapas. Esto sugiere la necesidad de un análisis más detallado de las capas climáticas antes de ser utilizadas en los modelos, ya que una variable inadecuada o con errores en su proyección puede afectar significativamente los resultados.
